...
> **차시 단위로 진행하려면** [08. 차시별 커리큘럼](docs/08-차시별-커리큘럼.md)을 보세요.
> Ex01~12과 i4h 워크플로를 15차시(주 2회 기준 8주)로 배열하고, 차시마다
> 산출물과 자가 점검 항목을 정해둔 진행표입니다. 마지막 15차시는
> [09. 프론티어 연구](docs/09-프론티어-연구.md) — 지금 장비로 할 수 없는 것과
> 그 너머에서 벌어지는 연구를 다룹니다.
...
- [08. 차시별 커리큘럼](docs/08-차시별-커리큘럼.md) — 15차시 진행표, 차시별 산출물과 자가 점검
- [09. 프론티어 연구](docs/09-프론티어-연구.md) — 3090의 천장, 자율성 레벨, 미해결 과제, 읽을거리
